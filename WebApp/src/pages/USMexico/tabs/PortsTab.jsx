  ...
  return (
    <>
      ...
      <SectionBlock>
        ...
        >
          <LineChart data={tradeTrendData} xKey="year" yKey="value" seriesKey="TradeType" formatY={getAxisFormatter(tradeMax, '$')} annotations={COVID_ANNOTATION} />
        </ChartCard>
      </SectionBlock>
      ...
      <SectionBlock alt>
        ...
        >
          <LineChart data={topPortTrendData} xKey="year" yKey="value" seriesKey="Port" formatY={getAxisFormatter(portTrendMax, '$')} annotations={COVID_ANNOTATION} />
        </ChartCard>
      </SectionBlock>
